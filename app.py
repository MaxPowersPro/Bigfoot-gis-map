...
with st.sidebar:
    ...
    with st.expander("💾 Saved Searches"):
        ...
        current_layers = {
            ...
            "layer_news": st.session_state.get("layer_news", True),
            "layer_hotspots": st.session_state.get("layer_hotspots", True),
            "layer_audio": st.session_state.get("layer_audio", True),
